"""
No tutorial-06, faremos o mesmo que o tutorial passado. Mas, desta vez carregaremos a imagem à partir de um arquivo. Visto isto, é importante que o arquivo a ser carregado esteja em uma pasta visível pelo python, de preferência na mesma em que se encontra o arquivo "main.py".
