...
def loadMedia():
	#Carregando textura
	if(not gNon2NTexture.loadTextureFromFile("opengl.png")):
...
def render():
	...
	#Renderizando textura opengl
	gNon2NTexture.render( ( SCREEN_WIDTH - gNon2NTexture.imageWidth() ) / 2, ( SCREEN_HEIGHT - gNon2NTexture.imageHeight() ) / 2)
