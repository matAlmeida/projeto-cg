...
class LTexture:
	...
	def loadPixelsFromFile(self,im):
		...
		if(im != None):
			...
			#Alocando memória para dados da texura
			size = texWidth * texHeigth
			self.mPixels = []
	...
	def loadTextureFromFileWithColorKey(self,imagem,r,g,b,a):
		...
		#Atualizando mPixels com os dados da imagem atual
